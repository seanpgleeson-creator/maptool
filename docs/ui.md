...
- **Sections to show:**
  ...
  3. **Policy consequences** — Whether the policy states **specific** steps (e.g. 1st warning, 2nd 90-day cutoff, 3rd suspension). If vague, call out: “Consequences are not specific; consider asking the vendor for clear steps.” *(User research)* **We support strict consequences when the vendor applies them uniformly.** When available: show **severity rating** (high/medium/low) and **timeline** for when consequences take effect. Some policies lack consequence details; others are very specific. Do not frame consequences as something to challenge.
  ...
  5. **Fulfillment & enforcement context (future)** — A separate section, not from the policy document. Placeholder for Target's fulfillment history with the vendor, to highlight known inventory issues related to MAP enforcement. Additional context when deciding whether to follow MAP. Coming later.
  6. **Next steps** — One clear line: **“Discuss with vendor”** or **“Proceed.”** Optional 1–2 bullet reasons (e.g. “MAP above market” or “Policy only applies to a segment”).
